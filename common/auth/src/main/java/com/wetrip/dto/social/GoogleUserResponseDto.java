...
public class GoogleUserResponseDto {
  ...
  public static GoogleUserResponseDto from(Map<String, Object> attributes,
    ...
    return GoogleUserResponseDto.builder()
        ...
        .gender(SocialResponseUtil.safeStringFromMap(additionalInfo, "gender"))
        .birthday(SocialResponseUtil.safeStringFromMap(additionalInfo, "birthday"))
        .contact(SocialResponseUtil.safeStringFromMap(additionalInfo, "contact"))
        .build();
  }
