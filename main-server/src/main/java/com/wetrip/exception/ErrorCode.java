...
public enum ErrorCode {
    ...
    MISSING_GENDER(HttpStatus.BAD_REQUEST, "성별은 필수 입력값입니다."),
    MISSING_AGE(HttpStatus.BAD_REQUEST, "나이는 필수 입력값입니다."),
    INVALID_TRIP_TYPE(HttpStatus.BAD_REQUEST, "유효하지 않은 여행 타입입니다. (1~6만 가능.)"),
